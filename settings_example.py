# Django settings for fbtools project.
...
DATABASE_NAME = 'fbtools'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '#dz51u2nn-x(0&y8r7_np6o+jeyx5aa2%_@btl!op*(cvm3)1x'
...
ROOT_URLCONF = 'fbtools.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/me/fbtools/photostream/templates'
)
